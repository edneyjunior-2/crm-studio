...
interface Item { etapa: string | null; codigo_sinapi: string | null; descricao: string; unidade: string | null; quantidade: number; custo_unitario: number; subtotal: number }
interface Orcamento {
...
interface Empresa { nome: string; razao_social: string | null; nome_fantasia: string | null; cnpj: string | null }

export function OrcamentoPdfView({ orcamento, itens, empresa }: { orcamento: Orcamento; itens: Item[]; empresa: Empresa | null }) {
  useEffect(() => { /* deixa o usuário disparar a impressão */ }, [])
