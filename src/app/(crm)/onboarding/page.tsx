...
import { FluxoForm } from '@/components/crm/onboarding/fluxo-form'
  ...
  if (error) {
    return (
      <div className="flex flex-col gap-6">
        <div>
          <h2 className="text-2xl font-bold tracking-tight text-foreground font-[family-name:var(--font-heading)]">Onboarding</h2>
          <p className="mt-1 text-sm text-muted-foreground">Boards Kanban para onboarding de clientes e processos internos.</p>
        </div>
        <div className="flex items-center justify-center rounded-xl border border-destructive/30 bg-destructive/5 py-10 text-center">
          <p className="text-sm text-destructive">Erro ao carregar fluxos de onboarding. Tente novamente mais tarde.</p>
        </div>
      </div>
    )
  }
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="mt-1 text-sm text-muted-foreground">
            Boards Kanban para onboarding de clientes e checklists de processos.
          </p>
        </div>
        {canManage && (
          <FluxoForm
      ...
      {lista.length === 0 ? (
        <div className="flex flex-col items-center justify-center rounded-xl border border-dashed border-border bg-muted/20 py-20 text-center gap-4">
          ...
          <div>
            ...
            <p className="mt-1 text-sm text-muted-foreground">
              {canManage
                ? 'Crie seu primeiro fluxo para organizar o onboarding de clientes.'
