...
const OBJECOES = [
  ...
  },
  {
    ...
    micro: 'Não achou o seu setor na lista? Fala com a gente: a gente ajusta os módulos existentes ou cria um específico pra sua área — sua empresa não precisa se adaptar ao sistema.',
  },
  {
